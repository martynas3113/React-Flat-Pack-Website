        ...
        return (
            ...
            <Container  className="video-container" >
                <Row className="video-wrap">
                    ...
                    <iframe className="video" src="https://player.vimeo.com/video/102732914?title=0&amp;byline=0&amp;portrait=0&amp;color=11b1c2&amp;wmode=opaque" width={510} height={300} frameBorder={0}  allowfullscreen="">
                        </iframe>
                    </Col>
                </Row>
            </Container>
